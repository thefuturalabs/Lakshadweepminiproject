import 'package:film_db_app/utils/text.dart';
import 'package:film_db_app/widgets/toprated.dart';
import 'package:film_db_app/widgets/trending.dart';
import 'package:film_db_app/widgets/tv.dart';
...
class HomeState extends State<Home> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        appBar: AppBar(
          title: const modified_text(text: 'Flutter Movie App ❤️', size: 25,),
